...
WebUI.setText(findTestObject('Login/input_My Greatway Office_email'), 'gw_oa_dummy@yopmail.com')
...
WebUI.verifyElementText(findTestObject('Main Page/Profile Dialog/div_user_OA'), 'Office Admin')
